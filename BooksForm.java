...
public class BooksForm extends JFrame {
	...
	public BooksForm() {
		...
		lblAddBooks.setFont(new Font("Chiller", Font.PLAIN, 36));
		...
		btnAddBooks.addActionListener(new ActionListener() {
			...
			if(callno==null||callno.trim().equals("")||name==null||name.trim().equals("")||author==null||author.trim().equals("")||publisher==null||publisher.trim().equals("")||squantity==null||squantity.trim().equals(""))
			{
				JOptionPane.showMessageDialog(BooksForm.this,"Values can't be blank!");
			}
			else {
