...
public class ReturnBook extends JFrame {
	...
	public ReturnBook() {
		...
		lblReturnBook.setFont(new Font("Chiller", Font.PLAIN, 36));
		...
		btnReturnBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sstudentid=textField_1.getText();
				if(bookcallno==null||bookcallno.trim().equals("")||sstudentid==null||sstudentid.trim().equals(""))
				{
					JOptionPane.showMessageDialog(ReturnBook.this,"Values can't be blank!");
				}
				else {
