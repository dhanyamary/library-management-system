...
public class IssueBookForm extends JFrame {
	...
	public IssueBookForm() {
		...
		setBounds(100, 100, 438, 470);
		contentPane = new JPanel();
		//contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		
		JLabel lblNewLabel = new JLabel("Issue Book ");
		lblNewLabel.setFont(new Font("Chiller", Font.PLAIN, 36));
		...
		btnIssueBook.addActionListener(new ActionListener() {
			...
			String sstudentid=textField_2.getText();
			String studentname=textField_3.getText();
			String studentcontact=textField_4.getText();
			
			if(bookcallno==null||bookcallno.trim().equals("")||sstudentid==null||sstudentid.trim().equals("")||studentname==null||studentname.trim().equals("")||studentcontact==null||studentcontact.trim().equals(""))
			{
				JOptionPane.showMessageDialog(IssueBookForm.this,"Values can't be blank!");
			}
				...
				JOptionPane.showMessageDialog(IssueBookForm.this,"Sorry, Book not available!");
			}
