...
public class LibrarianSuccess extends JFrame {
	...
	public LibrarianSuccess() {
		...
		lblLibrarianSection.setFont(new Font("Chiller", Font.PLAIN, 36));
		...
		btnViewBooks.setFont(new Font("Calibri light", Font.PLAIN, 18));
		...
		btnIssueBook.setFont(new Font("Calibri light", Font.PLAIN, 18));
		...
		btnViewIssuedBooks.setFont(new Font("Calibri light", Font.PLAIN, 18));
		...
		btnReturnBook.setFont(new Font("Calibri light", Font.PLAIN, 18));
		...
		btnLogout.setFont(new Font("Calibri light", Font.PLAIN, 18));
